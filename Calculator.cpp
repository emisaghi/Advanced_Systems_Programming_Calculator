    ...
    : QDialog(parent)
{
    ...
    Button *sineButton = createButton(tr("sin"), SLOT(unaryOperatorClicked()));
    Button *cosineButton = createButton(tr("cos"), SLOT(unaryOperatorClicked()));
    ...
    mainLayout->addWidget(sineButton, 1, 4);
    mainLayout->addWidget(cosineButton, 1, 5);
